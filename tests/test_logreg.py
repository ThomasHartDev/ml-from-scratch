...
def make_blobs(n=400, w=(3.0, -2.0), b=0.5, seed=0):
    """Two features, labels drawn from the true logistic model."""
...
def test_bce_finite_on_saturated_logits():
    # a confident-but-wrong prediction would make the naive log blow up
...
def test_decision_boundary_line():
    ...
    # every (x1, x2) on the line must sit exactly at logit zero
